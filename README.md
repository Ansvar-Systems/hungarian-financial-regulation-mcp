...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fhungarian-financial-regulation-mcp.svg)](https://www.npmjs.com/package/@ansvar/hungarian-financial-regulation-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/hungarian-financial-regulation-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/hungarian-financial-regulation-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/hungarian-financial-regulation/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add hungarian-financial-regulation-mcp --transport http https://mcp.ansvar.eu/hungarian-financial-regulation/mcp` |
...
```json
{
  "mcpServers": {
    "hungarian-financial-regulation-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/hungarian-financial-regulation/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/hungarian-financial-regulation-mcp
```
...
```json
{
  "mcpServers": {
    "hungarian-financial-regulation-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/hungarian-financial-regulation-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `hu_fin_search_regulations` | Full-text search across MNB (Magyar Nemzeti Bank) regulatory provisions. Returns matching rendeletek (decrees), ajanл... |
| `hu_fin_get_regulation` | Get a specific MNB regulatory provision by sourcebook and reference. Accepts references like |
| `hu_fin_list_sourcebooks` | List all MNB regulatory sourcebooks with their names and descriptions. |
| `hu_fin_search_enforcement` | Search MNB enforcement actions — bírságok (fines), határozatok (decisions), and sanctions against financial instituti... |
| `hu_fin_check_currency` | Check whether a specific MNB regulatory provision reference is currently in force. Returns status and effective date. |
| `hu_fin_about` | Return metadata about this MCP server: version, data source, tool list. |
