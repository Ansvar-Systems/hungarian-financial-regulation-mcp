/**
 * SQLite database access layer for the MNB financial regulation MCP server.
 *
 * Schema mirrors the MNB (Magyar Nemzeti Bank) regulatory structure:
 *   - sourcebooks        — top-level MNB regulatory sourcebook collections
 *   - provisions         — individual MNB rendeletek, ajanlasok, and vezeto korlevelek
 *   - enforcement_actions — MNB enforcement decisions and fines
 *
