...
const TOOLS = [
  {
    name: "hu_fin_search_regulations",
    description:
      "Full-text search across MNB (Magyar Nemzeti Bank) regulatory provisions. Returns matching rendeletek, ajanlasok, and vezeto korlevelek.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., MNB_Rendeletek). Optional." },
        status: {
          type: "string",
  ...
  {
    name: "hu_fin_get_regulation",
    description:
      "Get a specific MNB regulatory provision by sourcebook and reference.",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., MNB_Rendeletek)" },
        reference: { type: "string", description: "Provision reference (e.g., MNB rendelet 2/2015)" },
      },
      required: ["sourcebook", "reference"],
    },
  },
  {
    name: "hu_fin_list_sourcebooks",
    description: "List all MNB regulatory sourcebooks with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "hu_fin_search_enforcement",
    description:
      "Search MNB enforcement actions — birsagok (fines), hatarozatok (decisions), and sanctions.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  {
    name: "hu_fin_check_currency",
    description: "Check whether a specific MNB regulatory provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "Provision reference (e.g., MNB rendelet 2/2015)" },
      ...
      switch (name) {
        ...
        case "hu_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Magyar Nemzeti Bank (MNB) financial regulation MCP server. Provides access to MNB rendeletek, ajanlasok, vezeto korlevelek, and enforcement actions.",
            data_source: "MNB (https://www.mnb.hu/)",
